...
use cw721::{
    ...
    Expiration, NumTokensResponse, OperatorResponse, OperatorsResponse,
...
// #[derive(Serialize, Deserialize, Clone, Debug, PartialEq, JsonSchema)]
// pub struct MyNftInfoResponse {
//     pub access: OwnerOfResponse,
//     pub info: NftInfoResponse<Extension>,
// }

// #[derive(Serialize, Deserialize, Clone, Debug, PartialEq, JsonSchema)]
// pub struct NftInfoResponse<T = Extension> {
    ...
    Q: CustomMsg,
{
    ...
    fn all_nft_info(
        ...
        token_id: String,
        include_expired: bool,
    ) -> StdResult<cw721::AllNftInfoResponse<T>> {
        let info = self.tokens.load(deps.storage, &token_id)?;
