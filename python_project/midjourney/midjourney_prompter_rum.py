...
templates = [
    "a {fur_color} rum bottles on a ship called {ship} on a {background_color} background"
]
...
async def runner():
    ...
    for i in range(500):
        ...
        prompt = random.choice(templates).format(fur_color=fur_color, ship=ship, background_color=background_color)
